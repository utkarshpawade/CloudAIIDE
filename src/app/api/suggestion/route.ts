...
import { groqComplete, stripCodeFences, FAST_GROQ_MODEL } from "@/lib/groq";
...
Return ONLY the raw code to insert (or an empty response). Do not wrap it in markdown code fences and do not add any explanation.
</instructions>`;
...
export async function POST(request: Request) {
  try {
    ...
    const suggestion = stripCodeFences(raw);
